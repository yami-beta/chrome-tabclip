...
},{"./readinglist":299}],299:[function(require,module,exports){
'use strict';
...
var ReadingList = function () {
  function ReadingList(folderName) {
  ...
  _createClass(ReadingList, [{
    key: 'getFolder',
    value: function getFolder(folderName, parentId) {
      var _this = this;
      ...
      return this.search(folderOptions).catch(function () {
        return _this.create(folderOptions);
      });
    }
  }, {
    key: 'create',
    value: function create(folderOptions) {
      return new Promise(function (resolve, reject) {
        chrome.bookmarks.create(folderOptions, function (bookmark) {
          resolve(bookmark);
        });
      });
    }
    ...
    key: 'search',
    value: function search(folderOptions) {
      return new Promise(function (resolve, reject) {
        chrome.bookmarks.search(folderOptions, function (bookmarks) {
    ...
    value: function dateToString(date) {
      ...
      var secondString = ('0' + date.getSeconds()).slice(-2);
